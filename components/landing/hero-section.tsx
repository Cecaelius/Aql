...
const words = ["answer", "support", "guide", "scale"];
    ...
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-white/60">
            ...
            Aql by Neural Script · AI assistants for your business
          </span>
        </div>
        ...
        <div className="mb-12">
          ...
          >
            <span className="block whitespace-nowrap">Turn your business knowledge</span>
            <span className="block whitespace-nowrap">
              into an assistant that{" "}
      ...
      >
        <div className="max-w-[1400px] mx-auto flex items-start gap-10 lg:gap-20">
          {[
            { value: "24/7", label: "customer answers" },
            { value: "1 source", label: "of trusted knowledge" },
            { value: "any site", label: "plug-and-play deployment" },
          ].map((stat) => (
